            ...
            return {
                ...
                link: function ($scope, $element, $attrs) {
                    ...
                    $scope.getButtonText = function () {
                        if ($scope.settings.dynamicTitle && (angular.isArray($scope.selectedModel) && $scope.selectedModel.length > 0 || angular.isObject($scope.selectedModel) && Object.keys($scope.selectedModel).length > 0)) {
